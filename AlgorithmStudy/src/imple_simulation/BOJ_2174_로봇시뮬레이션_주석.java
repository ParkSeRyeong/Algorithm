...
public class BOJ_2174_로봇시뮬레이션_주석 {
	public static void main(String[] args) throws IOException {
		...
		for (int i = 1; i <= N; i++) {
			...
			robots[i][1] = c;
			map[row - r + 1][c] = i;
			System.out.print(i+"번째 로봇 : "+robots[i][0]+" "+robots[i][1]+" ");
			switch (st.nextToken()) {
			case "N":
				System.out.println("북쪽방향");
				robots[i][2] = 0;
				break;
			case "E":
				System.out.println("동쪽방향");
				robots[i][2] = 1;
				break;
			case "S":
				System.out.println("남쪽방향");
				robots[i][2] = 2;
				break;
			case "W":
				System.out.println("서쪽방향");
				robots[i][2] = 3;
				break;
			}
		}
